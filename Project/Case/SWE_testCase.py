...
def get_DEM_Still(x, y):
    return max(0.0, 0.25*((x-0.5)**2+(y-0.5)**2))
...
'''
poly_stocker = os.path.join("IUHM/Case_Stocker/Case_stocker.poly")
Stocker2poly(poly_stocker)

Tri2IUHM_Stocker("IUHM/Case_Stocker/Case_stocker.1.node", 8177, "IUHM/Case_Stocker/Case_stocker.1.edge", 23973, "IUHM/Case_Stocker/Case_stocker.1.ele", 15797,
         "IUHM/Case_Stocker/Case_stocker.1.v.edge", "IUHM/Case_Stocker/Case_Input")

prepareRainfall_zero(1, 70, 15797, "IUHM/Case_Stocker/Case_Input")
'''

# [2] Test: Still Water over a 2D Bump

poly_stocker = os.path.join("IUHM/Case_Still/Case_still.poly")
#Still2poly(poly_stocker)

Tri2IUHM_Still("IUHM/Case_Still/Case_still.1.node", 3291, "IUHM/Case_Still/Case_still.1.edge", 9662, "IUHM/Case_Still/Case_still.1.ele", 6372,
         "IUHM/Case_Still/Case_still.1.v.edge", "IUHM/Case_Still/Case_Input")
'''
prepareRainfall_zero(1, 400, 6372, "IUHM/Case_Still/Case_Input")
'''

# [3] Test: Partial Dam-Break Problem
'''
poly_pdb = os.path.join("IUHM/Case_PDB/Case_PDB.poly")
PDB2poly(poly_pdb)
Tri2IUHM_PDB("IUHM/Case_PDB/Case_PDB.1.node", 32020, "IUHM/Case_PDB/Case_PDB.1.edge", 95433, "IUHM/Case_PDB/Case_PDB.1.ele", 63414,
         "IUHM/Case_PDB/Case_PDB.1.v.edge", "IUHM/Case_PDB/Case_Input")
prepareRainfall_zero(1, 15, 63310, "IUHM/Case_PDB/Case_Input")
'''

# [4] Test: Dam Break on a Channel with Three Humps
'''
poly_ThreeHumps = os.path.join("IUHM/Case_ThreeHumps/Case_ThreeHumps.poly")
Tri2IUHM_ThreeHumps("IUHM/Case_ThreeHumps/Case_ThreeHumps.1.node", 7311, "IUHM/Case_ThreeHumps/Case_ThreeHumps.1.edge", 21613, "IUHM/Case_ThreeHumps/Case_ThreeHumps.1.ele", 14303,
         "IUHM/Case_ThreeHumps/Case_ThreeHumps.1.v.edge", "IUHM/Case_ThreeHumps/Case_Input")
ThreeHumps2poly(poly_ThreeHumps)
prepareRainfall_zero(1, 400, 14303, "IUHM/Case_ThreeHumps/Case_Input")
'''
